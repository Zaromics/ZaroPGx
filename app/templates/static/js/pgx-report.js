...
function exportToFhir() {
    ...
    const patientInfo = {
        id: pgxData.patientId,
        name: {
            family: patientFamilyName || "Unknown",
            given: patientGivenName ? [patientGivenName] : []
        }
    };
    ...
    fetch('/reports/' + pgxData.reportId + '/export-to-fhir', {
        method: 'POST',
        headers: {
    ...
    .finally(function() {
        ...
        exportBtn.innerHTML = 'Export to EHR';
    });
}
