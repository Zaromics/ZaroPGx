            ...
            try:
                ...
                return jsonify({
                    ...
                    "data": {
                        ...
                        "interactive_html_report_url": f"/reports/{base_name}_pgx_report_interactive.html",
                        # Add normalized URLs for PharmCAT original reports
                        "pharmcat_html_report_url": f"/reports/{base_name}_pgx_pharmcat.html" if report_html_file else None,
                        "pharmcat_json_report_url": f"/reports/{base_name}_pgx_pharmcat.json" if report_json_file else None,
                        "pharmcat_tsv_report_url": f"/reports/{base_name}_pgx_pharmcat.tsv" if report_tsv_file else None,
    ...
    try:
        ...
        return {
            ...
            "data": {
                ...
                # Add normalized URLs for PharmCAT original reports
                "pharmcat_html_report_url": f"/reports/{base_name}_pgx_pharmcat.html",
                "pharmcat_json_report_url": f"/reports/{base_name}_pgx_pharmcat.json",
                "pharmcat_tsv_report_url": f"/reports/{base_name}_pgx_pharmcat.tsv",
                "genes": genes_data,
