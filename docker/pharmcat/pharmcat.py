        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                return jsonify({
                    ...
                    "data": {
                        "job_id": base_name,
                        "html_report_url": f"/reports/interactive_report_{base_name}.html" if report_html_file else None,
                        "json_report_url": f"/reports/pharmcat_results_{base_name}.json" if report_json_file else None,
                        "tsv_report_url": f"/reports/pharmcat_summary_{base_name}.tsv" if report_tsv_file else None,
                        "raw_report_url": f"/reports/pharmcat_raw_{base_name}.json",
                        ...
                        "pharmcat_html_report_url": f"/reports/pharmcat_analysis_{base_name}.html" if report_html_file else None,
                        "pharmcat_json_report_url": f"/reports/pharmcat_results_{base_name}.json" if report_json_file else None,
                        "pharmcat_tsv_report_url": f"/reports/pharmcat_summary_{base_name}.tsv" if report_tsv_file else None,
